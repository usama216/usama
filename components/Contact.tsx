...
const Contact = () => {
  ...
  const handleMailClick = () => {
    window.open("mailto:usamajawad125@gmail.com", "_self");
  };
  ...
  return (
    ...
    >
      ...
      </p><p className="max-w-[600px] text-center text-textGreen">
  <a href="mailto:usamajawad125@gmail.com">usamajawad125@gmail.com</a>
</p>
